...
const server_url = process.env.NODE_ENV === 'production' ? 'https://hacksmart.herokuapp.com/' : "http://localhost:4001"
		...
		return (
			<div>
				{this.state.askForUsername === true ?
					...
					:
					<div>
						<div className="btn-down" style={{ backgroundColor: "#152238", color: "#0492C2", textAlign: "center" }}>
							...
							{this.state.screenAvailable === true ?
								<IconButton style={{ color: "#ffffff" }} onClick={this.handleScreen}>
									{this.state.screen === true ? <ScreenShareIcon /> : <StopScreenShareIcon />}
								</IconButton>
								: null}

							<Badge badgeContent={this.state.newmessages} max={999} color="secondary" onClick={this.openChat}>
								<IconButton style={{ color: "#ffffff" }} onClick={this.openChat}>
									<ChatIcon />
								</IconButton>
							</Badge>
						</div>
